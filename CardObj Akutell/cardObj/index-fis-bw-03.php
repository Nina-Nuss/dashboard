...
<script>
    ...
    window.onload = function() {
        ...
        Umgebung.startCarouselLoop(); //Carousel starten
        // Umgebung.carouselLeeren(); //30 Sekunden warten und dann Carousel leeren
    }
    ...
    class CardObj {
        ...
        htmlKonstruktObjBody(umgebung) {
            var htmlUmgebungsBody = document.getElementById(umgebung.bodyForCards);
    ...
    //         }
    //     }
    //     async repeatUpdateCarousel(umgebungsObj) {
