  ...
  <div id="selectPanel">
      <div class="col-md-12 mx-auto pl-auto bg-gray-100">
          <div class="d-flex justify-content-center gap-2" id="startBtns">
              <button id="homeBereich" onclick="homeSeite()" type="button" class="btn text-dark start-btn" 
              ...
              <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                      <li><a id="infotherminalBereich" class="dropdown-item" href="#">Infoseite Einstellungen</a></li>
