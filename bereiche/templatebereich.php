            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body" id="cardBodyForDelSchema" style="max-height: 400px; overflow-y: auto;">
                        ...
                        <div class="border rounded p-3 mb-3" style="max-height: 300px; overflow-y: auto; overflow-x: hidden; border-radius: 8px;" id="deleteSchema">
                            <!-- Schema-Liste wird hier dynamisch geladen -->
